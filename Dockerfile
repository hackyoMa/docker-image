...
ENV SENTINEL_VERSION=1.8.8 SENTINEL_HOME=/usr/share/sentinel JAVA_OPTIONS="-Dfile.encoding=utf-8 -Dserver.port=8080 -Dcsp.sentinel.dashboard.server=localhost:8080 -Dproject.name=sentinel-dashboard"
