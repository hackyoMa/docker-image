...
ENV ELASTICSEARCH_VERSION=6.6.0 ELASTICSEARCH_HOME=/usr/share/elasticsearch
...
HEALTHCHECK --interval=10s --timeout=5s --start-period=30s --retries=3 CMD curl -f http://localhost:9200/_cat/health || exit 1
EXPOSE 9200 9300
