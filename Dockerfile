...
LABEL org.opencontainers.image.authors="hackyo" \
      ...
      org.opencontainers.image.source="https://github.com/hackyoMa/docker-image/tree/jdk-25"
...
RUN set -eux; \
    ...
    mkdir -p "${JAVA_HOME}"; \
    tempDir="$(mktemp -d)"; \
    tarUrl="https://cdn.azul.com/zulu/bin/zulu25.34.17-ca-jdk25.0.3-linux_${arch}.tar.gz"; \
