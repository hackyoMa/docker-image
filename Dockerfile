...
LABEL org.opencontainers.image.authors="hackyo" \
      ...
      org.opencontainers.image.source="https://github.com/hackyoMa/docker-image/tree/jre-11"
...
RUN set -eux; \
    ...
    mkdir -p "${JAVA_HOME}"; \
    tempDir="$(mktemp -d)"; \
    tarUrl="https://cdn.azul.com/zulu/bin/zulu11.88.17-ca-jre11.0.31-linux_${arch}.tar.gz"; \
