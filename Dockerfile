...
RUN mkdir /usr/local/keycloak && \
    ...
    mkdir -p /usr/local/keycloak/modules/system/layers/keycloak/com/mysql/jdbc/main && \
    curl -L https://repo1.maven.org/maven2/mysql/mysql-connector-java/8.0.22/mysql-connector-java-8.0.22.jar -o /usr/local/keycloak/modules/system/layers/keycloak/com/mysql/jdbc/main/mysql-connector-java.jar

COPY mysql-module.xml /usr/local/keycloak/modules/system/layers/keycloak/com/mysql/jdbc/main/module.xml
