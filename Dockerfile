...
LABEL org.opencontainers.image.authors="hackyo" \
      ...
      org.opencontainers.image.source="https://github.com/hackyoMa/docker-image/tree/jdk-17"
...
RUN set -eux; \
    ...
    mkdir -p "${JAVA_HOME}"; \
    tempDir="$(mktemp -d)"; \
    tarUrl="https://cdn.azul.com/zulu/bin/zulu17.66.19-ca-jdk17.0.19-linux_${arch}.tar.gz"; \
