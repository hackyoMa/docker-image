...
LABEL org.opencontainers.image.authors="hackyo" \
      ...
      org.opencontainers.image.source="https://github.com/hackyoMa/docker-image/tree/jre-21"
...
RUN set -eux; \
    ...
    mkdir -p "${JAVA_HOME}"; \
    tempDir="$(mktemp -d)"; \
    tarUrl="https://cdn.azul.com/zulu/bin/zulu21.50.19-ca-jre21.0.11-linux_${arch}.tar.gz"; \
