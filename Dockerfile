...
LABEL org.opencontainers.image.authors="hackyo" \
      ...
      org.opencontainers.image.source="https://github.com/hackyoMa/docker-image/tree/jre-17"
...
RUN set -eux; \
    ...
    mkdir -p "${JAVA_HOME}"; \
    tempDir="$(mktemp -d)"; \
    tarUrl="https://cdn.azul.com/zulu/bin/zulu17.66.19-ca-jre17.0.19-linux_${arch}.tar.gz"; \
